...
\begin{body}
	...
	\vspace*{-4pt}
	\begin{itemize} \itemsep -0pt %reduce space between items
		\item Managed a 150TB storage array with several hundred active users, several thousand total users. Provided compute and storage resources for research and coursework.
	\end{itemize}
	\vspace*{-4pt}
